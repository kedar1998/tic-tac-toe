...
const SignIn = () => {
  ...
  const { name, loginUser, error } = useAppContext();
            ...
            <form className="flex flex-col gap-3 items-start w-full mt-14">
              ...
              <div className="my-3">
                <input
                  ...
                  className="bg-transparent md:w-96 border-b-2 border-[#777777] placeholder:text-[#777777] pb-2 outline-none mb-1 text-sm"
              ...
              <div className="mt-14">
                <button
                  ...
                  onClick={handleClick}
                  disabled={!email && !password.length}
                >
                  Sign in
                </button>
              </div>
